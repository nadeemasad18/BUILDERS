            ...
            <div class="page-breadcrumb">
                <div class="row align-items-center">
                    <div class="col-6">
                        ...
                        <h1 class="mb-0 fw-bold">Welcome back, <?php echo $this->session->fname;?></h1> 
                    </div>
                    ...
                    <div class="col-12">
                        <div class="card">
                            <div class="card-body">
                                ...
                                <div class="d-md-flex">
                                    <div>
                                        <h4 class="card-title">Manage Your Properties</h4>
                                        <h5 class="card-subtitle">View, edit, or delete your properties</h5>
                                        <?php echo $this->session->flashdata('property_removed');?>
                                        <?php echo $this->session->flashdata('remove_error');?>
                                    </div>
                                
                                </div>
                                <!-- title -->
                                <div class="table-responsive">
                                    <table id="data" class="table mb-0 table-hover align-middle text-nowrap">
                                        <thead>
                                            <tr>
                                                ...
                                                <th class="border-top-0">Remove Property</th>
                                            </tr>
                                        </thead>
                                        <tbody>
                                            <?php
                                            ...
                                            echo '
                                            <tr>
                                            <td class="text-dark font-16"><image loading="lazy" src="'.$row->property_image.'" class="img-fluid" style="width: 150px; height: 100px;"/></td>
                                            <td>'.$row->property_address.'</td>
                                            <td>'.$row->property_city.'</td>
                                            <td>'.$row->property_state.'</td>
                                            <td>'.$row->zipcode.'</td>
                                            <td>$'.$row->property_value.'</td>
                                            <td><a href="property/'.$row->property_id.'">More Details</a></td>
                                            <td><a class="btn btn-danger text-white" href="remove_property/'.$row->property_id.'">Remove Listing</a></td>
                                            </tr>
                                            ';
                                            }
                                            ?>
